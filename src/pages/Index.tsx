  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
        <SheetContent side="right" className="p-0 w-80 max-w-[80vw]">
          <Sidebar />
        </SheetContent>
      </Sheet>
      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-6rem)]">
        {/* Desktop Sidebar */}
        <div className="hidden lg:block sticky top-24 h-[calc(100vh-6rem)] w-80 flex-shrink-0">
          <Sidebar />
        </div>
        ...
        <main className="flex-1 w-full overflow-x-hidden animate-fade-in">
          ...
          <section id="reciters" className="py-12 sm:py-16 md:py-20 bg-muted/20 relative overflow-hidden">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center mb-8 sm:mb-12">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">قائمة مشايخ تونس</h2>
                <p className="text-muted-foreground text-sm sm:text-base">استمع إلى أروع التلاوات برواية قالون عن نافع بأصوات تونسية أصيلة</p>
              </div>
              <ReciterList />
            </div>
          </section>
          ...
          {/* Footer */}
          <footer className="py-12 sm:py-16 bg-gradient-to-b from-muted/30 to-muted/50 border-t border-primary/10 elegant-border elegant-gradient">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
                  ...
                  <div className="text-center sm:text-right">
                    <div className="flex items-center justify-center sm:justify-end gap-3 mb-4">
                      <img
                        src={zaytounaEmblem}
                        alt="مصحف الزيتونة"
                        className="w-16 h-16 sm:w-20 sm:h-20 object-contain opacity-90 hover:opacity-100 transition-opacity hover:scale-105 duration-300"
                        onError={(e) => {
                          const target = e.target as HTMLImageElement;
                          target.src = "/zaytouna-emblem.svg";
                          target.className = "w-16 h-16 sm:w-20 sm:h-20 object-contain opacity-70";
                        }}
                      />
                      <div>
                        <h3 className="text-xl sm:text-2xl font-bold bg-gradient-islamic bg-clip-text text-transparent">
                          مصحف الزيتونة
                        </h3>
                        <p className="text-xs sm:text-sm text-muted-foreground mt-1">الرقمية للقرآن الكريم</p>
                      </div>
                    </div>
                  ...
                  <div className="text-center">
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li><a href="#reading" className="hover:text-primary transition-colors block py-1">القراءة</a></li>
                      <li><a href="#memorization" className="hover:text-primary transition-colors block py-1">الحفظ</a></li>
                      <li><a href="#quiz" className="hover:text-primary transition-colors block py-1">الاختبارات</a></li>
                      <li><a href="#tadabbur" className="hover:text-primary transition-colors block py-1">التدبر</a></li>
                    </ul>
                  </div>
